...
# Install common system dependencies. libreoffice-core/writer/calc/impress let
# us convert office documents to PDF at upload time so we can attach them
# natively to multimodal models (see utils/document_conversion.py).
RUN apt-get update && \
